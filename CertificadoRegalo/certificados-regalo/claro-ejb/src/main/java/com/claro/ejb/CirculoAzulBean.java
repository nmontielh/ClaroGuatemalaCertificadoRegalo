...
implements SessionBean {
    ...
    public UsuarioTO consultaEmpleado(String numEmpleado, String sIP, String passActual, boolean validaPwd) throws CAException {
        return this.usuarioDAO.consultaEmpleado(numEmpleado, sIP, passActual, validaPwd);
    }
    ...
    public boolean actualizaUsuario(UsuarioTO usuarioCA, UsuarioTO usuarioActualizado, int perfilAnterior) throws Exception {
        return this.usuarioDAO.actualizaUsuario(usuarioCA, usuarioActualizado, perfilAnterior);
    }
    ...
    public ArrayList<AlianzasTO> consultaCanjesAlianzas(String cuenta, String secuencia) throws CAException {
    ...
    public TelefonoTO procedimientoGeneral(ParametrosTO parametrosTO, PerfilTO perfilTO, String fzaVentas) throws CAException {
        return this.consultasDAO.procedimientoGeneral(parametrosTO, perfilTO, fzaVentas);
    }

    public FactorTO consultaFactor(int idAlianza, int nPtsDisp) throws CAException {
        return this.alianzasDAO.consultaFactor(idAlianza, nPtsDisp);
    }

    public ArrayList<CatalogoTO> getMarcas(int region, int grupo) throws CAException {
        CatalogoDAO catalogoDAO = new CatalogoDAO();
        return catalogoDAO.getMarcas(region, grupo);
    }

    public ArrayList<CatalogoTO> getModelos(String marca, int region, int grupo, String fzaVentas) throws CAException {
        CatalogoDAO catalogoDAO = new CatalogoDAO();
    ...
    public String consultaPrecioEquipo(String plan, int region, String marca, String modelo, String estatus) throws CAException {
        return this.consultasDAO.consultaPrecioEquipo(plan, region, marca, modelo, estatus);
    }
    ...
    public RedencionTO aplicaredencion(ProductosTO productosTO, ParametrosTO parametrosTO, RedencionTO redencionTO, boolean isEcac, boolean isDistribuidores, String endPoint, String usuario, BeneficioTO beneficioTO, String endpointGap) throws CAException {
        ...
        return redencionDAO.aplicaredencion(productosTO, parametrosTO, redencionTO, isEcac, isDistribuidores, endPoint, usuario, beneficioTO, endpointGap);
    }

    public TelefonoTO procedimientoGeneralPuntitos(ParametrosTO parametrosTO) throws CAException {
    ...
    public ArrayList<ProductosTO> listaPromociones(int iRegion, int iRangoPuntos, String sPlan, int iGrupoPromo, String cacsFzaVenta, String todosFzaVenta, String marca, String modelo) throws CAException {
        return this.catalogoDAO.listaPromociones(iRegion, iRangoPuntos, sPlan, iGrupoPromo, cacsFzaVenta, todosFzaVenta, marca, modelo);
    }
    ...
    public ArrayList<ProductosTO> consultaProductos(String ptsExactos, String marca, String modelo, TelefonoTO telefonoTO, UsuarioTO usuarioTO, String tipoRed, String formaRed, String planNuevo, double costoPuntos, String cacsFzaVenta, String todosFzaVenta, String fzaVentasDistribuidores, int mesAdendum, int diaAdendum, int diasMesAdendum, int adendumNuevo, String endpointGap) throws CAException {
        return this.catalogoDAO.consultaProductos(ptsExactos, marca, modelo, telefonoTO, usuarioTO, tipoRed, formaRed, planNuevo, costoPuntos, cacsFzaVenta, todosFzaVenta, fzaVentasDistribuidores, mesAdendum, diaAdendum, diasMesAdendum, adendumNuevo, endpointGap);
    }
    ...
    public MensajeTO actualizaPassword(String _usuario, String _passActual, String _passNuevo, String _passConfirm) throws CAException {
        AdministracionDAO adminDAO = new AdministracionDAO();
        return adminDAO.actualizarPassword(_usuario, _passActual, _passNuevo, _passConfirm);
    }
    ...
    public ArrayList<RedencionTO> consultaFolioSAP(String folio, String tipoRedencion, String estatus, int secuencia, String cuenta, int region, boolean consultaM2K) throws CAException {
        return this.consultasDAO.consultaFolioSAP(folio, tipoRedencion, estatus, secuencia, cuenta, region, consultaM2K);
    }
    ...
    public ImpresionTO datosConstanciaImpresion(String sTelefono, String cuenta, String fechaFolio, String folio, String fechaOperacion, String tipoReden) throws CAException {
        ...
        return impresionDAO.datosConstanciaImpresion(sTelefono, cuenta, fechaFolio, folio, fechaOperacion, tipoReden);
    }
    ...
    public ReservacionTO realizaApartado(ReservacionTO reservacionTO, TelefonoTO telefonoTO, boolean isDistribuidores, String fzaVentas) throws CAException {
        RedencionDAO redencionDAO = new RedencionDAO();
        return redencionDAO.realizaApartado(reservacionTO, telefonoTO, isDistribuidores, fzaVentas);
    }
    ...
    public ImpresionTO obtieneConstanciaAlianzas(String sFecha, String sCuenta, int iSecuencia, int tipoAlianza, String sFechaFolio, String sLinea) throws CAException {
        ImpresionDAO impresionDAO = new ImpresionDAO();
        return impresionDAO.obtieneConstanciaAlianzas(sFecha, sCuenta, iSecuencia, tipoAlianza, sFechaFolio, sLinea);
    }
    ...
    public ArrayList<ImpresionTO> detalleImpresionAlianzas(String sFecha, String sCuenta, int iSecuencia, int tipoAlianza, String sFolio) throws CAException {
        ImpresionDAO impresionDAO = new ImpresionDAO();
        return impresionDAO.detalleImpresionAlianzas(sFecha, sCuenta, iSecuencia, tipoAlianza, sFolio);
    }
    ...
    public MensajeTO cancelaApartado(ParametrosTO parametrosTO, UsuarioTO usuarioTO, boolean isDistribuidores) throws CAException {
        RedencionDAO redencionDAO = new RedencionDAO();
        return redencionDAO.cancelaApartado(parametrosTO, usuarioTO, isDistribuidores);
    }
    ...
    public MensajeTO actualizaPromoAlianza(String sCuentaAl, int iCveAl, String sCuenta, int iSecuencia, String sNombre, String sApePat, String sApeMat, String sUsrCve, String sTel) throws CAException {
        AlianzasDAO alianzasDAO = new AlianzasDAO();
        return alianzasDAO.actualizaPromoAlianza(sCuentaAl, iCveAl, sCuenta, iSecuencia, sNombre, sApePat, sApeMat, sUsrCve, sTel);
    }

    public MensajeTO altaPromoAlianza(String sCuentaAl, int iCveAl, String sCuenta, int iSecuencia, String sNombre, String sApePat, String sApeMat, String sUsrCve, String sTel) throws CAException {
        AlianzasDAO alianzasDAO = new AlianzasDAO();
        return alianzasDAO.altaPromoAlianza(sCuentaAl, iCveAl, sCuenta, iSecuencia, sNombre, sApePat, sApeMat, sUsrCve, sTel);
    }

    public MembresiaTO consultaMembresia(String cuenta, int secuencia, Date fecha) throws CAException {
        MembresiaDAO membresiaDAO = new MembresiaDAO();
    ...
    public MensajeTO confirmaCanje(int lValViaje, FolioLiberacionTO folioLiberacion, int lNumAcomp, String lIdCanje, String sCuenta, int isecuencia, String sTelefono, String sUsuario, int iRegion) throws CAException {
        AlianzasDAO alianzasDAO = new AlianzasDAO();
        return alianzasDAO.confirmaCanje(lValViaje, folioLiberacion, lNumAcomp, lIdCanje, sCuenta, isecuencia, sTelefono, sUsuario, iRegion);
    }
    ...
    public MensajeTO cancelaRedencion(ParametrosTO parametrosTO, String fechaOperacion, int diasValidacion, UsuarioTO usuarioTO) throws CAException {
        RedencionDAO redencionDAO = new RedencionDAO();
        return redencionDAO.cancelaRedencion(parametrosTO, fechaOperacion, diasValidacion, usuarioTO);
    }

    public TransferenciaTO transfierePuntosAnexo(TransferenciaTO transfTO) throws CAException {
    ...
    public TransferenciaTO transfierePuntosRegion(TransferenciaTO transfTO) throws CAException {
    ...
    public ArrayList<AlianzasTO> consultaCancelaCanje(String telefono, String cuentaAlianza, int opcion) throws CAException {
        return this.consultasDAO.consultaCancelaCanje(telefono, cuentaAlianza, opcion);
    }

    public MensajeTO realizaCancelacion(ParametrosTO parametrosTO, int estatusTrans) throws CAException {
        AlianzasDAO alianzasDAO = new AlianzasDAO();
        return alianzasDAO.realizaCancelacion(parametrosTO, estatusTrans);
    }

    public MensajeTO realizaCanje(ParametrosTO parametrosTO, int millasPorTranferir, int valorPuntos, String descAlianza, String cuentaAlianza, int ptsTransferir, int valorCertificado, String puntoVenta, String numEmpleado, String dirIP, String idViaje, int valorPesos, String referencia, int opcion) throws CAException {
        AlianzasDAO alianzasDAO = new AlianzasDAO();
        return alianzasDAO.realizaCanje(parametrosTO, millasPorTranferir, valorPuntos, descAlianza, cuentaAlianza, ptsTransferir, valorCertificado, puntoVenta, numEmpleado, dirIP, idViaje, valorPesos, referencia, opcion);
    }

    public MensajeTO cancelaAlianza(String sCuenta, String sCuentaAl, int iCveAl) throws CAException {
        AlianzasDAO alianzasDAO = new AlianzasDAO();
    ...
    public ArrayList<ImpresionTO> detalleEquipo(String sFecha, String sTipoRed, String sFechaFolio, String sCuenta, String sTelefono) throws CAException {
        ImpresionDAO impresionDAO = new ImpresionDAO();
        return impresionDAO.detalleEquipo(sFecha, sTipoRed, sFechaFolio, sCuenta, sTelefono);
    }
    ...
    public ReservacionTO consultaFolioReservacion(String folio, String estatus) throws CAException {
        return this.consultasDAO.obtieneReservacion(folio, estatus, false);
    }

    public Hashtable<String, AlianzasTO> consultaInicialAlianzas(int iRegion, String sCuenta, int nPtsDisp, int iSecuencia) throws CAException {
        AlianzasDAO alianzasDAO = new AlianzasDAO();
        return alianzasDAO.consultaInicialAlianzas(iRegion, sCuenta, nPtsDisp, iSecuencia);
    }

    public AlianzasTO consultaPromocionesAmex(int alianza, int iRegion, String linea, int iSecuencia, int ptosDisponibles) throws CAException {
        AlianzasDAO alianzasDAO = new AlianzasDAO();
        return alianzasDAO.consultaPromocionesAmex(alianza, iRegion, linea, iSecuencia, ptosDisponibles);
    }
    ...
    public MensajeTO procesaAsignacion(ParametrosTO parametrosTO, String usuario, int accion, int ptsAsignar, String comentario, String motivoAsig) throws CAException {
        ...
        return asignacionDAO.procesaAsignacion(parametrosTO, usuario, accion, ptsAsignar, comentario, motivoAsig);
    }
    ...
    public MensajeTO validaImpresion(String sFolio, Date dfechaM2K) throws CAException {
        RetencionDAO retencionDAO = new RetencionDAO();
    ...
    public MensajeTO cancelarCertificado(String sUsuario, String sModo, String sFolio, String sComenta) throws CAException {
        RetencionDAO retencionDAO = new RetencionDAO();
        return retencionDAO.cancelarCertificado(sUsuario, sModo, sFolio, sComenta);
    }
    ...
    public FolioLiberacionTO asignaPorAntiguedad(ParametrosTO parametrosTO, String lFecAltaM2K, String comentario, String usuario) throws CAException {
        AsignacionDAO asignacionDAO = new AsignacionDAO();
        return asignacionDAO.asignaPorAntiguedad(parametrosTO, lFecAltaM2K, comentario, usuario);
    }
    ...
    public void obtenFacturaciones(MobileTO mobileTO, int region, String cuenta, int numFacturas) throws CAException {
        ...
        consultaM2KDAO.obtenFacturaciones(mobileTO, region, cuenta, numFacturas);
    }
    ...
    public MensajeTO almacenaCertificado(TelefonoTO telefonoTO, UsuarioTO usuarioTO, RetencionTO retencionTO, String sNMeses, String sMotivo, String sComenta, String sComenta2, String sCuentaAnt, String sRegionAnt, String sMesesAnt, String sTipo) throws CAException {
        RetencionDAO retencionDAO = new RetencionDAO();
        return retencionDAO.almacenaCertificado(telefonoTO, usuarioTO, retencionTO, sNMeses, sMotivo, sComenta, sComenta2, sCuentaAnt, sRegionAnt, sMesesAnt, sTipo);
    }
    ...
    public ImpresionTO datosImpresion(String telefono, String fechaFolio) throws CAException {
        ImpresionDAO impresionDAO = new ImpresionDAO();
    ...
    public ArrayList<AvisosTO> historicoAvisos(String sFechaIni, String sFechaFin, String tipoAviso, String estatus) throws CAException {
        ...
        return avisosDAO.historicoAvisos(sFechaIni, sFechaFin, tipoAviso, estatus);
    }
    ...
    public MensajeTO insertarAvisos(String sDescripcion, String sFechaFin, String sTipoAviso, String sUsuario, String sFechaInicio) throws CAException {
        AvisosDAO avisosDAO = new AvisosDAO();
        return avisosDAO.insertarAvisos(sDescripcion, sFechaFin, sTipoAviso, sUsuario, sFechaInicio);
    }
    ...
    public void actualizaPrivilegios(int idPerfil, List<PrivilegioTO> privilegios, String numEmpleado) throws CAException {
        this.seguridadDAO.actualizaPrivilegios(idPerfil, privilegios, numEmpleado);
    }
    ...
    public List<CertificadoLealtadTO> getCertificadosLealtad(String fechaInicial, String fechaFinal, int idRegion) throws CAException {
        return this.reportesCirculoAzulDAO.getCertificadosLealtad(fechaInicial, fechaFinal, idRegion);
    }

    public List<RedencionReporteTO> getRedenciones(String fechaInicial, String fechaFinal, int idRegion) throws CAException {
        return this.reportesCirculoAzulDAO.getRedenciones(fechaInicial, fechaFinal, idRegion);
    }
    ...
    public List<RedencionLineaTO> getRedencionesLinea(String fechaInicial, String fechaFinal, List<String> lineas) throws CAException {
        return this.reportesCirculoAzulDAO.getRedencionesLinea(fechaInicial, fechaFinal, lineas);
    }
    ...
    public ArrayList<PromocionTO> consultaPromocionesDistribuidores(PromocionTO promocionTO, String idPlan, int idGpoPromocion) throws Exception {
        PromocionesDAO promocionesDAO = new PromocionesDAO();
        return promocionesDAO.consultaPromocionesDistribuidores(promocionTO, idPlan, idGpoPromocion);
    }
    ...
    public ArrayList<ReservacionServiceTO> consultaFoliosDistribuidores(String telefono, String cuenta, String fzaVenta) throws CAException {
        return this.consultasDAO.consultaFolioDistribuidores(telefono, cuenta, fzaVenta);
    }
    ...
    public List<RedencionesOnlineTO> getRedencionesOnline(String fechaInicial, String fechaFinal, int idRegion) throws CAException {
        return this.reportesCirculoAzulDAO.getRedencionesOnline(fechaInicial, fechaFinal, idRegion);
    }
    ...
    public boolean aplicaRedencionMulticotizador(String idVariable) throws Exception {
        ...
        return Boolean.parseBoolean(redencionMultiDAO.obtienePropiedad(idVariable));
    }
    ...
    public ArrayList<PlanTO> planesSisact(int region, String tecnologia, String modalidad, String mixto, String banSisact, String tipoPlan, String fzaVenta) throws CAException {
        return this.consultasDAO.planesSisact(region, tecnologia, modalidad, mixto, banSisact, tipoPlan, fzaVenta);
    }

    public boolean aplicaRedencionSisact(String folio, TelefonoServiceTO telefonoTO, String claveSisact) throws CAException {
        RedencionDAO redencionDAO = new RedencionDAO();
        return redencionDAO.aplicaRedencionSisact(folio, telefonoTO, claveSisact);
    }
    ...
    public Hashtable<String, Object> validaProductoDescuento(String telefono, int region, String cuenta, String endPoint, String usuario) throws CAException {
        RedencionDAO redencionDAO = new RedencionDAO();
        return redencionDAO.validaProductoDescuento(telefono, region, cuenta, endPoint, usuario);
    }
    ...
    public void AsignacionPorErrorAplic(AsignaPorErrorTO asignaPorErrorTO, String Cuenta, String Telefono, String numempleado) throws CAException {
        ...
        asignacionPorErrorAplicaDAO.AsignacionPorErrorAplic(asignaPorErrorTO, Cuenta, Telefono, numempleado);
    }

    public boolean VerificasiexisteAPTOE(String Cuenta, String Telefono) throws CAException {
        AsignacionPorErrorAplicaDAO asignacionPorErrorAplicaDAO = new AsignacionPorErrorAplicaDAO();
        return asignacionPorErrorAplicaDAO.VerificasiexisteAPTOE(Cuenta, Telefono);
    }
    ...
    public ArrayList<MembresiaTO> consultaDatosM2KMembresias(ParametrosTO parametrosTO, FileDataTO fileDataTO) throws CAException {
        ConsultaM2KDAO consultaM2KDAO = new ConsultaM2KDAO();
        return consultaM2KDAO.consultaDatosM2KMembresias(parametrosTO, fileDataTO);
    }
    ...
    public TelefonoTO cuentaDestinoCancelacion(String cuentaOrigen, int secuenciaOrigen) throws CAException {
        ...
        return transferencia.cuentaDestinoCancelacion(cuentaOrigen, secuenciaOrigen);
    }
    ...
    public ArrayList<PerfilTO> obtienePerfilesAsignacion(int idPerfilN, int numPtosMaximo) throws CAException {
        AsignacionDAO asignacionDAO = new AsignacionDAO();
        return asignacionDAO.obtienePerfilesAsignacion(idPerfilN, numPtosMaximo);
    }

    public boolean actualizaPrivilegiosAsignacion(int idPerfilN, int numMaxPtos, String numEmpleado) throws CAException {
        return this.seguridadDAO.actualizaPrivilegiosAsignacion(idPerfilN, numMaxPtos, numEmpleado);
    }

    public boolean actualizaPerfilAsignacion(int idPerfilN, int numMaxPtos, String numEmpleado) throws CAException {
        return this.seguridadDAO.actualizaPerfilAsignacion(idPerfilN, numMaxPtos, numEmpleado);
    }
    ...
    public ArrayList<MotivoTO> obtieneMotivosAsignacion(String idMotivo, String descripcion, int estatus) throws CAException {
        AsignacionDAO asignacionDAO = new AsignacionDAO();
        return asignacionDAO.obtieneMotivosAsignacion(idMotivo, descripcion, estatus);
    }

    public boolean insertaMotivoAsignacion(String idMotivo, String descripcion, int estatus) throws CAException {
        AsignacionDAO asignacionDAO = new AsignacionDAO();
        return asignacionDAO.insertaMotivoAsignacion(idMotivo, descripcion, estatus);
    }

    public boolean actualizaMotivoAsignacion(String idMotivo, String descripcion, int estatus) throws CAException {
        AsignacionDAO asignacionDAO = new AsignacionDAO();
        return asignacionDAO.actualizaMotivoAsignacion(idMotivo, descripcion, estatus);
    }
    ...
    public List<InbursaTO> getInbursaRentas(String fechaInicial, String fechaFinal, int idRegion) throws CAException {
        ...
        reportesCirculoAzulDAO.getInbursaRentas(fechaInicial, fechaFinal, idRegion);
        return reportesCirculoAzulDAO.getInbursaRentas(fechaInicial, fechaFinal, idRegion);
    }

    public List<InbursaTO> getInbursaMinutos(String fechaInicial, String fechaFinal, int idRegion) throws CAException {
        ReportesCirculoAzulDAO reportesCirculoAzulDAO = new ReportesCirculoAzulDAO();
        reportesCirculoAzulDAO.getInbursaMinutos(fechaInicial, fechaFinal, idRegion);
        return reportesCirculoAzulDAO.getInbursaMinutos(fechaInicial, fechaFinal, idRegion);
    }

    public List<InbursaTO> getInbursaDescuento1000(String fechaInicial, String fechaFinal, int idRegion) throws CAException {
        ReportesCirculoAzulDAO reportesCirculoAzulDAO = new ReportesCirculoAzulDAO();
        reportesCirculoAzulDAO.getInbursaMinutos(fechaInicial, fechaFinal, idRegion);
        return reportesCirculoAzulDAO.getInbursaDescuento1000(fechaInicial, fechaFinal, idRegion);
    }

    public List<InbursaTO> getInbursaPaquetes(String fechaInicial, String fechaFinal, int idRegion) throws CAException {
        ReportesCirculoAzulDAO reportesCirculoAzulDAO = new ReportesCirculoAzulDAO();
        reportesCirculoAzulDAO.getInbursaPaquetes(fechaInicial, fechaFinal, idRegion);
        return reportesCirculoAzulDAO.getInbursaPaquetes(fechaInicial, fechaFinal, idRegion);
    }
    ...
    public List<MovimientoCertificadoTO> consultaMovimientosTajetaCertificado(String numeroCertificado) throws ClaroException {
        ...
        return certificadosDAO.consultaMovimientosTajetaCertificado(numeroCertificado);
    }

    public TarjetaCertificadoTO consultaSaldoTarjetaCertificado(String numeroCertificado) throws ClaroException {
        CertificadosDAO certificadosDAO = new CertificadosDAO();
        return certificadosDAO.consultaSaldoTarjetaCertificado(numeroCertificado);
    }
    ...
    public ActivacionTarjetaCertificadoTO activaTarjetaCertificado(String numeroTarjeta, long montoCertificado, String idUsuario) throws ClaroException {
        CertificadosDAO certificadosDAO = new CertificadosDAO();
        return certificadosDAO.activaTarjetaCertificado(numeroTarjeta, montoCertificado, idUsuario);
    }
    ...
    public MensajeServiceTO cancelaTarjetaCertificado(String numeroCertificado, String idUsuario) throws ClaroException {
        CertificadosDAO certificadosDAO = new CertificadosDAO();
        return certificadosDAO.cancelaTarjetaCertificado(numeroCertificado, idUsuario);
    }
    ...
    public MensajeServiceTO cancelaAplicaCertificado(String folio, String idUsuario, String idpuntoVta, String referencia) throws ClaroException {
        CertificadosDAO certificadosDAO = new CertificadosDAO();
        return certificadosDAO.cancelaAplicaCertificado(folio, idUsuario, idpuntoVta, referencia);
    }
    ...
    public String consultaTajetaVendida(String numeroTarjeta, long montoCertificado) throws ClaroException, RemoteException {
        CertificadosDAO certificadosDAO = new CertificadosDAO();
        return certificadosDAO.consultaTajetaVendida(numeroTarjeta, montoCertificado);
    }
}
