...
/*     */ {
/*  11 */   static Locale currentLocale = new Locale("en", "US");
/*     */   
/*  13 */   public static final SimpleDateFormat TIMEFORMAT = new SimpleDateFormat("hh:mm:ss", currentLocale);
/*  14 */   public static final SimpleDateFormat DATEFORMATyyyyMMdd = new SimpleDateFormat("yyyyMMdd", currentLocale);
/*  15 */   public static final SimpleDateFormat DATEFORMATyyyy_MM_dd = new SimpleDateFormat("yyyy-MM-dd", currentLocale);
/*  16 */   public static final SimpleDateFormat DATEFORMATdd_MM_YYYY = new SimpleDateFormat("dd-MM-yyyy", currentLocale);
/*  17 */   public static final SimpleDateFormat DATEFORMATMM_dd_YYYY = new SimpleDateFormat("MM/dd/yyyy", currentLocale);
/*  18 */   public static final SimpleDateFormat DATEFORMATdd_MM_YYYY_2 = new SimpleDateFormat("dd/MM/yyyy", currentLocale);
/*  19 */   public static final SimpleDateFormat DATEFORMATMM_dd_YYYY_HHmmss = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss", currentLocale);
/*  20 */   public static final SimpleDateFormat DATEFORMTALog = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss", currentLocale);
/*  21 */   public static final SimpleDateFormat DATEFORMTAyyyy_MM_ddHHmmss = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", currentLocale);
/*  22 */   public static final SimpleDateFormat yyyyMMddHHmmss = new SimpleDateFormat("yyyyMMddHHmmss", currentLocale);
/*  23 */   public static DecimalFormat formatea = new DecimalFormat("###,###,###,##0");
/*  24 */   public static final DecimalFormat DECIMAL_FORMATTER = new DecimalFormat("###.00");
/*  25 */   public static final DecimalFormat DECIMAL_FORMATTER_PRECIOS = new DecimalFormat("###,###,###,###.00");
/*     */   
/*     */   public static final int ID_ALIANZA_MILLAS = 1;
/*     */   
/*     */   public static final double CONSTOPUNTO = 0.021D;
/*     */   
...
/* 159 */   public static int ELIMINAR_PUNTOS = 1;
/* 160 */   public static int ASIGNAR_PUNTOS = 2;
/*     */   
...
/*     */   {
/* 236 */     C103("SBL_CAM_0103", "Error de proceso 1%"), 
/* 237 */     C104("SBL_CAM_0104", "El formato del número telefónico es incorrecto"), 
/* 238 */     C105("SBL_CAM_0105", "La longitud del mensaje es mayor a 150 caracteres"), 
/* 239 */     C106("SBL_CAM_0106", "La longitud del número telefónico es diferente a 10 caracteres"), 
/* 240 */     C107("SBL_CAM_0107", "El mensaje XML no esta bien estructurado"), 
/* 241 */     C108("SBL_CAM_0108", "El mensaje no se deposito"), 
/* 242 */     C109("SBL_CAM_0109", "El mensaje se deposito correctamente");
/*     */     
/*     */     private final String valor;
/*     */     private final String descripcion;
/*     */     
/*     */     private CODIGO_ERROR(String codigo, String mensaje) {
/* 248 */       this.valor = codigo;
/* 249 */       this.descripcion = mensaje;
/*     */     }
/*     */     
/*     */     public String getValor() {
/* 253 */       return this.valor;
/*     */     }
/*     */     
/*     */     public String getDescripcion() {
/* 257 */       return this.descripcion;
/*     */     }
/*     */   }
/*     */   
...
/* Location:              /opt/trabajo/claro/Guatemala/IS/CO/ClaroClub.ear!/ClaroClubEJBClient.jar!/com/claro/util/Constantes.class
