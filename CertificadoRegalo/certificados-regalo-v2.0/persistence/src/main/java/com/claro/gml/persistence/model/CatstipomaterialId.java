...
/**
 * CatstipomaterialId generated by hbm2java
 */
@Embeddable
public class CatstipomaterialId implements java.io.Serializable {

	private String cvetipomaterial;
	private String descripcion;
	private BigDecimal activo;

	public CatstipomaterialId() {
	}

	public CatstipomaterialId(String cvetipomaterial) {
		this.cvetipomaterial = cvetipomaterial;
	}

	public CatstipomaterialId(String cvetipomaterial, String descripcion, BigDecimal activo) {
		this.cvetipomaterial = cvetipomaterial;
		this.descripcion = descripcion;
		this.activo = activo;
	}

	@Column(name = "CVETIPOMATERIAL", nullable = false, length = 9)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CatstipomaterialId))
			return false;
		CatstipomaterialId castOther = (CatstipomaterialId) other;

		return ((this.getCvetipomaterial() == castOther.getCvetipomaterial())
