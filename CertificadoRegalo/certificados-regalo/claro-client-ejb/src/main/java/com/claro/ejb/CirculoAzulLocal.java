...
public interface CirculoAzulLocal
extends EJBLocalObject {
    ...
    public List<MovimientoCertificadoTO> consultaMovimientosTajetaCertificado(String var1) throws ClaroException;

    public TarjetaCertificadoTO consultaSaldoTarjetaCertificado(String var1) throws ClaroException;

    public ActivacionTarjetaCertificadoTO activaTarjetaCertificado(String var1, long var2, String var4) throws ClaroException;

    public MensajeServiceTO aplicaCertificado(MovimientoCertificadoTO var1) throws ClaroException;

    public MensajeServiceTO cancelaTarjetaCertificado(String var1, String var2) throws ClaroException;

    public MensajeServiceTO cancelaAplicaCertificado(String var1, String var2, String var3, String var4) throws ClaroException;

    public boolean consultaTajeta(String var1, long var2) throws ClaroException;

    public TarjetaCertificadoTO consultaSaldoCertificado(String var1) throws ClaroException, RemoteException;

    public List<MovimientoCertificadoTO> consultaMovimientosCertificado(String var1) throws ClaroException;

    public String consultaTajetaVendida(String var1, long var2) throws ClaroException;
}
