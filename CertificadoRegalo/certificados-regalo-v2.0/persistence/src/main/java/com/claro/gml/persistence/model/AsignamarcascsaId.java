...
/**
 * AsignamarcascsaId generated by hbm2java
 */
@Embeddable
public class AsignamarcascsaId implements java.io.Serializable {
	...
	public AsignamarcascsaId() {
	}

	public AsignamarcascsaId(String cvemarca, String cveoficinadeventas, String region, Boolean vigente) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AsignamarcascsaId))
			return false;
		AsignamarcascsaId castOther = (AsignamarcascsaId) other;
